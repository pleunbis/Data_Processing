...
// load dataset
d3.json("euc.json", function(error, data) {
...
// set domain for data 
var x_pos = x.domain([d3.max(data, function(d) { return d.GDP_capita; }), 0]).nice();
var y_pos = y.domain(d3.extent(data, function(d) { return d.Wellbeing; })).nice();
